    ...
    <div className="space-y-6">
      ...
      <div className="bg-white px-4 py-2 rounded-lg shadow">
        <div className="flex items-center gap-6 text-sm text-gray-700">
          <span>
            <span className="text-gray-500">{t('orders.stats.total')}:</span>
            <span className="ml-2 font-medium">{stats.total}건</span>
          </span>
          <span>
            <span className="text-gray-500">{t('orders.stats.processing')}:</span>
            <span className="ml-2 font-medium">{stats.processing}건</span>
          </span>
          <span>
            <span className="text-gray-500">{t('orders.stats.delivered')}:</span>
            <span className="ml-2 font-medium">{stats.delivered}건</span>
          </span>
          <span>
            <span className="text-gray-500">{t('orders.stats.refunded')}:</span>
            <span className="ml-2 font-medium">{stats.refunded}건</span>
          </span>
        </div>
      </div>
